...
<h2 className="text-lg font-bold text-gray-800 flex-1">Job detail</h2>
{canEdit && (
<Link
href={'/jobs/' + id + '/edit'}
className="text-xs text-aas-blue border border-aas-blue/30 px-2.5 py-1 rounded-lg hover:bg-aas-blue-pale transition-colors"
>
Edit
</Link>
)}
...
<h3 className="text-base font-semibold text-gray-800 flex-1">{job.title}</h3>
</div>
