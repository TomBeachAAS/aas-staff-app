...
export function CustomerTasks() {
  ...
  // pathname = /customers/[id]  or /customers/[id]/edit — grab segment at index 2
  ...
  useEffect(() => {
    if (!customerId || segments[3]) {
      // Don't show on /customers/[id]/edit etc.
      setLoading(false);
      return;
    }
  ...
  // Only show on the detail page (no extra segment after [id])
